...
class App extends PureComponent {
  ...
  filterArr = (key, val,equal) => {
    ...
    let newData;
    if(equal){
      return newData = data.filter(item => item[key] === val);
    } else{
      return newData = data.filter(item => item[key] !== val);
    }
  }
  ...
  fieldSelect = (field) => {
    ...
    switch (field) {
      case "allSelect":
        ...
        break;
      case "noSelect":
        newData = this.filterArr("isChecked", false)
        this.setState({ newData });
        break;
      case "isSelect":
        newData = this.filterArr("isChecked", true)
        this.setState({ newData });
        break;
      case "batchDel":
        newData = this.filterArr("isChecked", false)
    ...
    return (field) => {
      switch (field) {
        case "subItem":
          ...
          break;
        case "blur":
          this.setState({ data, newData: data, editID: null });
          break;
        case "mouseOut":
        ...
        case "toggle":
          let checked = true;
          let newData = this.mapArr(id, "", checked);
          this.setState({ data: newData, newData });
          break;
        default:
          break;
